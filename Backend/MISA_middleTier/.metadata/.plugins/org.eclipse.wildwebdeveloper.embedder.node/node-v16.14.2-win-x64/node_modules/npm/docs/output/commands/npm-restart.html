...
<polygon fill="#ffffff"
	...
	<section id="content">
		...
		<div id="_content">
			...
			<pre lang="bash">
				<code>npm restart [-- &lt;args&gt;]
</code>
			</pre>
			<h3 id="description">Description</h3>
			<p>
				This restarts a project. It is equivalent to running
				<code>npm run-script restart</code>
				.
			</p>
			<p>
			...
			<p>
				If it does <em>not</em> have a
				<code>"restart"</code>
				script specified, but it does have
				<code>stop</code>
				and/or
				<code>start</code>
				scripts, then the following scripts will be run:
			</p>
			<ol>
				<li>prerestart</li>
				<li>prestop</li>
		...
		<footer id="edit">
			<a
				href="https://github.com/npm/cli/edit/latest/docs/content/commands/npm-restart.md">
