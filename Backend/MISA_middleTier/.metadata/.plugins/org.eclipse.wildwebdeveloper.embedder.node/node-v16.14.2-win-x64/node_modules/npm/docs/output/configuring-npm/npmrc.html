			...
			<div id="_table_of_contents">
				<ul>
					...
					<ul>
						...
						<li><a href="#per-project-config-file">Per-project config
								file</a></li>
		...
		<div id="_content">
			...
			<p>
				For a list of available configuration options, see <a
					href="../using-npm/config.html">config</a>.
			</p>
...
@myscope:registry=https://mycustomregistry.example.org
		...
		<footer id="edit">
			<a
				href="https://github.com/npm/cli/edit/latest/docs/content/configuring-npm/npmrc.md">
